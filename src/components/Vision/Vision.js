...
const VisionComponent = () => {
  return (
    <div className="vision" id="roadmap">
      <div className="container">
        <div className="row">
          ...
          <div className="col-6">
            ...
            <div className="text">
              Our goal is to bring DeFi to the masses by streaming how users
              interact with the Dapp on mobile devices and expand the miner
              rewards pool application to other blockchains for increased
              liquidity and sustainability.
            </div>
          </div>
        </div>
        <div className="row" style={{ marginTop: "100px" }}>
        <div className="col-6 rocket-field">
          ...
          <div className="col-6">
            <div className="phase">
              ...
              <ul className="subtext">
                ...
                <li>
                  Launch Central Community Marketing Efforts (Shill Group)
                </li>
              </ul>
            </div>
            <div className="phase">
            ...
            <div className="phase">
              ...
              <ul className="subtext">
                ...
                <li>
                  Ability to purchase token or $CRO and deposit to contracts
                  from mobile app using flat credit card
                </li>
